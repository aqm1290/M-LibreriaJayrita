            ...
            <div class="px-8 md:px-10 py-8 md:py-10 bg-gradient-to-b from-white to-amber-50/60">
                <form wire:submit="abrirCaja" class="space-y-8">
                    ...
                    <div class="text-center pt-2">
                        ...
                        <p class="mt-3 text-[0.7rem] text-amber-800/70">
                ...
                {{-- RESUMEN ABAJO --}}
                <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 bg-amber-50 border border-amber-200 rounded-2xl px-4 md:px-5 py-4 text-xs md:text-sm">
                    <div>
