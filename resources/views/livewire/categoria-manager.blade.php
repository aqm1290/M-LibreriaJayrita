<div class="min-h-screen bg-slate-50 py-12 px-6">
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @forelse($categorias as $cat)
                            <tr class="{{ $cat->activo ? 'hover:bg-slate-50/60' : 'bg-rose-50/30 hover:bg-rose-50/60' }} transition-colors">
                                ...
                                <td class="px-8 py-5 align-top">
                                    <span class="inline-flex items-center px-4 py-1.5 rounded-full bg-amber-100 text-amber-800 font-semibold text-xs">
    ...
    <!-- MODAL CREAR / EDITAR -->
    @if($modal)
        <div class="fixed inset-0 bg-slate-900/60 flex items-center justify-center z-50 p-6">
            <div class="bg-white rounded-3xl shadow-3xl w-full max-w-2xl overflow-hidden border border-slate-100">
                <div class="bg-gradient-to-r from-gray-800 to-black text-white px-8 py-6 text-center rounded-t-3xl">
                ...
                <div class="px-8 py-7 space-y-6">
                    <div>
                        ...
                        <input
                            type="text"
                            wire:model="nombre"
                            class="w-full px-5 py-3 rounded-2xl border border-slate-200 bg-white/80 text-sm
    ...
    <!-- MODAL CONFIRMAR -->
    @if($confirmDelete)
        <div class="fixed inset-0 bg-slate-900/70 flex items-center justify-center z-50 p-6">
            <div class="bg-white rounded-3xl shadow-3xl max-w-md w-full px-8 py-7 text-center border border-slate-100">
                <div class="w-20 h-20 mx-auto mb-5 rounded-2xl flex items-center justify-center
                    ...
                    <svg
                        class="w-10 h-10 {{ $this->categoria?->activo ? 'text-rose-600' : 'text-emerald-600' }}"
