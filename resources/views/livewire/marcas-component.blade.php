<div class="min-h-screen bg-gray-50 py-12 px-6">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-10">
            <div>
                <h1 class="text-5xl font-black text-gray-900">Gestión de Marcas</h1>
                <p class="text-xl text-gray-600 mt-2">Administra todas las marcas de tu catálogo</p>
            </div>
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($marcas as $m)
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-8 py-6 font-bold text-gray-900 text-lg">{{ $m->nombre }}</td>
        ...
        <div class="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-6">
            <div class="bg-white rounded-2xl shadow-3xl w-full max-w-2xl">
                ...
                <div class="p-10 space-y-8">
                    <div>
                        <label class="block text-lg font-bold text-gray-800 mb-3">Nombre de la marca *</label>
    ...
    @if($confirmDelete)
        <div class="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-6">
            <div class="bg-white rounded-2xl shadow-3xl max-w-md w-full p-10 text-center">
                ...
                <h3 class="text-3xl font-black text-gray-900 mb-4">¿Eliminar marca?</h3>
                <p class="text-lg text-gray-600 mb-8">
                    Esta acción no se puede deshacer.<br>
                    @if($marca_id && ($marca = \App\Models\Marca::find($marca_id)) && $marca->productos()->count() > 0)
                        <strong class="text-red-600">¡Hay {{ $marca->productos()->count() }} productos asociados!</strong>
                    @endif
                </p>
